...
<div class="add_show_user container">
      ...
      <!-- -----------------------------------------------   -->
      <div class="  form-container shadow rounded form">
        <style type="text/css">
          
        </style>
        <form class="form col-12" method="post" action="../controller/ajoutUtil.php" enctype="multipart/form-data">
        <fieldset>
          <legend style="text-align: left;color: #dfad49; " >Ajouter utilisateur</legend>
            ...
            <div class="mb-3">
              ...
              <input type="text" id="login" name="identifiant" class="form-control" placeholder=" login">
            </div>
            ...
            <div class="mb-3 ">
              ...
              <input type="password" id="confmotDepasse" name="confpassword" class="form-control" placeholder=" ">
              <p id="alert">  </p>
            </div>
            <button  style="background-color: #dfad49;margin-bottom: 30px;" type="submit" id="click" class="btn mx-auto">Ajouter</button>
